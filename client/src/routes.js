...
import { Login, AllPets, PetTypes, Matches, MatchSingle, } from './components'; //UserHome, CreateProfile, UpdateProfile, EmailPreview
import App from './App';
...
const mapState = state => ({
  // Being 'logged in' for our purposes will be defined has having a state.user that has a true id.
  // Otherwise, state.user will be an empty object, and state.user.id will be false
